...
<body class="bg-gray-100 flex">
    ...
    <aside class="relative bg-blue-800 lg:w-1/5 md:-1/3 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="index.html" class="text-blue-100 sm:text-2xl text-xl font-medium hover:text-gray-300 tracking-wide" style="font-family: 'Lato',sans-serif;"><?php echo $r['Firstname']; ?></a>
            <p class="leading-relaxed text-gray-400 font-normal">Student</p>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-blue-800 py-5 px-6 sm:hidden">
            <div class="flex items-center justify-between">
                <a href="index.html" class="text-blue-100 sm:text-2xl text-xl font-medium hover:text-gray-300 tracking-wide" style="font-family: 'Lato', sans-serif';"><?php echo $r['Firstname']; ?>
        ...
        <div class="w-full overflow-x-hidden border-t pb-8 flex flex-col">
            <main class="w-full flex-grow p-6 mb-8">
                ...
                <div class="leading-relaxed text-gray-600">Select the courses to opt for the upcoming semester from the <a href="http://www.iiitmanipur.ac.in/snippets/ECE-CSESyllabus.pdf" target="blank"><span class="text-blue-500 hover:underline">list of courses.</span></a>
                  <span class="leading-relaxed text-green-600 italic ml-4 font-normal text-base"><?php 
            ...
            <div class="lg:w-9/12 md:w-11/12 bg-white shadow-2xl contact-container p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0">
                ...
                <form action="updatestudentcourse.php" method="POST">
                    <div class="rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                      <div class="-mx-3 md:flex md:mb-8 mb-0">
                        <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                          ...
                          <input class="w-full bg-white text-black border border-gray-300 rounded py-3 px-4 mt-2 mb-3 focus:outline-none focus:border-blue-800" type="text" name="fname" value="<?php echo $r['Firstname']; ?>" required readonly="readonly" >
                        </div>
                        <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                          <label class="tracking-wide text-blue-900 text-base font-bold mb-2">
                            Middle name
                          </label>
                          <input class="w-full bg-white text-black border border-gray-300 rounded py-3 px-4 mt-2 mb-3 focus:outline-none focus:border-blue-800" type="text" name="mname" value="<?php echo $r['Middlename']; ?>" required readonly="readonly" >
                        </div>
                        <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                          <label class="tracking-wide text-blue-900 text-base font-bold mb-2">
                            Last name
                          </label>
                          <input class="w-full bg-white text-black border border-gray-300 rounded py-3 px-4 mt-2 mb-3 focus:outline-none focus:border-blue-800" type="text" name="lname" value="<?php echo $r['Lastname']; ?>" required readonly="readonly" >
                        </div>
                      ...
                      <div class="-mx-3 md:flex md:mb-8 mb-0">
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                          ...
                          <input class="w-full bg-white text-black border border-gray-300 rounded py-3 px-4 mb-3 mt-2 focus:outline-none focus:border-blue-800" id="title" type="text" name="roll" value="<?php echo $r['RollNumber']; ?>" required readonly="readonly" >
                        </div>
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                          <label class="tracking-wide text-blue-900 text-base font-bold" for="location">
                            Programme
                          </label>
                          <select class="w-full bg-white border border-gray-300 text-black text-base py-3 px-4 pr-8 mb-3 rounded mt-2 focus:outline-none focus:border-blue-800" id="department" name="program" required readonly="readonly" >
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                          ...
                          <div>
                            <div>
                              <select class="w-full bg-white border border-gray-300 text-black text-base py-3 px-4 pr-8 mb-3 rounded mt-2 focus:outline-none focus:border-blue-800" id="department" name="departmentsubmit" required readonly="readonly" >
                    ...
                    <div class="-mx-3 md:flex md:mb-8 mb-4">
                      <div class="md:w-1/2 md:mr-4 px-3 mb-6 md:mb-0">
                        ...
                        <input class="w-full bg-white text-black border border-gray-300 rounded py-3 px-4 mb-3 mt-2 focus:outline-none focus:border-blue-800" id="title" type="text" name="contact" pattern="^[6-9]\d{9}$" placeholder="10 digit mobile no." required>
                      </div>
                      ...
                      <div class="md:w-1/2 md:mr-4 px-3 mb-6 md:mb-0">
                        ...
                        <input class="w-full bg-white text-black border border-gray-300 rounded py-3 px-4 mb-3 mt-2 focus:outline-none focus:border-blue-800" id="title" type="text" name="fathername" placeholder="Father's full name" required>
                      </div>
                    </div>
                    ...
                    <div class="-mx-3 md:flex md:mb-8 mb-4">
                      <div class="md:w-1/2 md:mr-4 px-3 mb-6 md:mb-0">
                        ...
                        <select class="w-full bg-white border border-gray-300 text-black text-base py-3 px-4 pr-8 mb-3 rounded mt-2 focus:outline-none focus:border-blue-800" id="department" name="sem" required readonly="readonly" >
