     ...
     if(filter_var($email, FILTER_VALIDATE_EMAIL)==true)
      {
        ...
        //insert info in SQLiteDatabase
          ...
          if($insert)
          {
            ...
            $header="From: vermashashank97@gmail.com \r\n";
...
<body>
 ...
 <input class="form__input bg-white rounded border border-gray-400 focus:outline-none focus:border-blue-500 text-base px-4 py-2 mt-3" placeholder="email" name="email" type="text">
 <label for="email" class="form__label ml-4 text-xs">Email <address></address></label>

 <button id="login" class="text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg mb-6 mt-4">Send password to email</button>
