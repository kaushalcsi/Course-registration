...
<head>
    ...
    <title>Academic Section Dashbboard</title>
...
<body class="bg-gray-100 flex">
    ...
    <aside class="relative bg-blue-800 lg:w-1/5 md:-1/3 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="index.html" class="text-blue-100 sm:text-2xl text-xl font-medium hover:text-gray-300 tracking-wide" style="font-family: 'Lato';">Academic section</a>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-blue-800 py-5 px-6 sm:hidden">
            <div class="flex items-center justify-between">
                <a href="index.html" class="text-blue-100 sm:text-2xl text-xl font-medium hover:text-gray-300 tracking-wide" style="font-family: 'Lato';">Academic Section
        ...
        <div class="w-full border-t flex flex-col">
            <main class="w-full flex-grow p-6 mb-6">
                <h1 class="sm:text-3xl text-2xl text-black font-semibold mb-3">Academic Dashboard</h1>
                <div class="leading-relaxed text-gray-600">Select even or odd courses and verify student details.
        ...
        <table align="center" border="2px" class="table-auto mb-10">
                <tr>
                    <th colspan="12"><h1>Payment details</h1></th>
                </tr>
                    <t class="border">
                        <th class="w-1/4 border py-2">Firstname</th>
                        <th class="w-1/8 border py-2">Middlename</th>
                        <th class="w-1/4 border py-2">Lastname</th>
                        <th class="w-1/4 border px-2">Roll Number</th>
                        <th class="w-1/8 px-2 border">Programme</th>
                        <th class="w-1/8 px-2 border">Department</th>
                        <th class="w-1/8 border px-2">Semester</th>
                        <th class="w-1/8 border px-2">Contact</th>
                        <th class="w-1/4 border px-2">Father name</th>
                        <th class="w-1/4 border px-2">Backlog</th>
                    ...
                    <?php
                      ...
                      <tr class="text-center">
                        <td class="w-1/4 border"><?php echo $r['fName']; ?></td>
                        <td class="w-1/8 border"><?php echo $r['mName']; ?></td>
                        <td class="w-1/4 border"><?php echo $r['lName']; ?></td>
                        <td class="w-1/4 border"><?php echo $r['studentID']; ?></td>
                        <td class="w-1/8 border"><?php echo $r['Program']; ?></td>
                        <td class="w-1/8 border"><?php echo $r['Department']; ?></td>
                        <td class="w-1/8 border"><?php echo $r['semester']; ?></td>
                        <td class="w-1/8 border"><?php echo $r['mobileNo']; ?></td>
                        <td class="w-1/4 border"><?php echo $r['fatherName']; ?></td>
                        <td class="w-1/4 border"><?php echo $r['Backlogs']; ?></td>
                                    

                         <td>
                             <form action="updateacadstatus.php" method="post">
