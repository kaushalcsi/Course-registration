    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full flex items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                    ...
                    <a href="#" class="block px-4 py-2 account-link hover:text-white hover:bg-blue-700">Sign Out</a>
                </div>
            </div>
        </header>
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6 mb-8">
                ...
                <div class="leading-relaxed text-gray-600">Verify student fee payment details from list of students below.</div>

            </main>

            <table align="center" border="2px" style="width:1100px; line-height:20px;">
                <tr>
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td><?php echo $r['RollNumber']; ?></td>
                        <td><?php echo $r['Programme']; ?></td>
                        <td><?php echo $r['Department']; ?></td>
                        <td><?php echo $r['Semester']; ?></td>
                        <td><?php echo $r['Category']; ?></td>
                        <td><?php echo $r['Disability']; ?></td>
                        <td><?php echo $r['Modeofpayment']; ?></td>
                        <td><?php echo $r['Dateofpayment']; ?></td>
                        <td><?php echo $r['Referenceno']; ?></td>
                        <td><form action="updatestatus.php" method="post">
                          <div class="form_group">
                          <div>
                          <select name="statussubmit[]">
