    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6 mb-8">
                ...
                <div class="leading-relaxed text-gray-600">Select the courses for Semester.</div>
        ...
        <div class="md:w-1/2 md:mr-4 px-3 mb-6 md:mb-0">
          ...
          <select class="w-full bg-white border border-gray-100 text-black text-base py-3 px-4 pr-6 mb-3 rounded mt-2 focus:outline-none focus:border-blue-800" id="department" name="eosemester" action="post" id="mySelect" onChange="document.getElementById('selectedValue').innerHTML = this.value;" >
            <option value=""> </option>
